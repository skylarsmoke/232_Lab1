...
public class PQueueArrival extends AbstractCollection<Job> {
	...
	private static class DefaultComparator implements Comparator<Job> {
		...
		public int compare(Job o1, Job o2) {
			...
			return o2.getArrival() - o1.getArrival();
		}
    ...
    public PQueueArrival(Comparator<Job> e) {
    ...
    public PQueueArrival(Collection<Job> e) {
